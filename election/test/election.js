...
contract("Election",function(accounts) {
    ...
    //         assert.equal(voteCount,1,"candidate 1 doesnot receive any votes");
    //         return electionInstance.candidates(2);  
    //     }).then(function(candidate2) {
    //         var voteCount = candidate2[2];
    //         assert.equal(voteCount,0,"candidate 2 doesnot receive any votes");
    //     }); 
    // });
    ...
    //     }).then(function(candidate2) {
    //         var voteCount = candidate2[2];
    //         assert.equal(voteCount,1,"candidate 2 doesnot receive any votes");
    //     }); 
    // });
